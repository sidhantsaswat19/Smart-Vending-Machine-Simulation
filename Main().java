        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    Espresso myEspresso = new Espresso(espressoName,espressoRoast,espressoPrice,numberOfShots);// TODO 8: Create an object of Espresso class using the parameterized constructor
                    // TODO 8: Pass the espressoName, espressoRoast, espressoPrice, and numberOfShots as arguments in the correct order

                    myEspresso.grindBeans();// TODO 9: Call the grindBeans() method on the Espresso object

                    myEspresso.brewCoffee();// TODO 10: Call the brewCoffee() method on the Espresso object

                    myEspresso.printInfo();// TODO 11: Call the printInfo() method on the Espresso object

                    myEspresso.printEspressoDetails();// TODO 12: Call the printEspressoDetails method on the Espresso object
                ...
                case 2:
                    ...
                    Latte myLatte = new Latte(latteName,latteRoast,lattePrice,milkType,syrupFlavor);// TODO 20: Create an object of Latte class using the parameterized constructor
                    // TODO 20: Pass the latteName, latteRoast, lattePrice, milkType, and syrupFlavor as arguments in the correct order

                    myLatte.grindBeans();// TODO 21: Call the grindBeans() method on the Latte object

                    myLatte.brewCoffee();// TODO 22: Call the brewCoffee() method on the Latte object

                    myLatte.printInfo();// TODO 23: Call the printInfo() method on the Latte object

                    myLatte.printLatteDetails();// TODO 24: Call the printLatteDetails() method on the Latte object
